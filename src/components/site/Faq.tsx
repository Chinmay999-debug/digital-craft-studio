...
const faqs = [
  [
    ...
    "We design and build custom business websites and custom business software — CRMs, dashboards and internal tools — with automation and AI capabilities built into them where useful.",
  ],
  [
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:gap-16">
          <Reveal>
            ...
            <p className="mt-4 max-w-sm text-sm text-muted-foreground">
              Anything else, ask directly — we answer scope and pricing questions before
