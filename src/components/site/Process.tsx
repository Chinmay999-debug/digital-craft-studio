  ...
  return (
    <section id="process" className="bg-ivory-2 py-20 lg:py-24">
      <div className="mx-auto max-w-[1600px] px-6 lg:px-10">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] lg:gap-16">
          <div className="relative">
            <span className="absolute top-2 bottom-2 left-[13px] w-px bg-border" />
            <span
              className="absolute left-[13px] w-px bg-brand transition-all duration-500"
            ...
            <div className="space-y-2">
              {steps.map((s, i) => (
                <div
                  ...
                  className={cn(
                    "relative cursor-default rounded-lg py-5 pr-4 pl-12 transition-colors",
                    active === i ? "bg-card shadow-panel" : "hover:bg-ivory-3/60",
                  )}
                >
                  <span
                    className={cn(
                      "absolute top-7 left-[7px] size-3.5 rounded-full border-2 transition-colors",
                      active === i
